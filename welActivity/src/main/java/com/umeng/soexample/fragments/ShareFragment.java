...
//        setShareContent();
        ...
        // 设置分享内容
        mController.setShareContent("abc");
// 设置分享图片, 参数2为图片的url地址
        mController.setShareMedia(new UMImage(getActivity(),
                "http://image.uuu9.com/pcgame/dota2/UploadFiles/201504/201504181115246071.jpg"));

        UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler(getActivity(), "1103881747",
                "gCZ4dZXtG5JMtBOe");
        qqSsoHandler.addToSocialSDK();

        QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler(getActivity(), "1103881747",
                "gCZ4dZXtG5JMtBOe");
...
//设置分享图片
        qqShareContent.setShareImage(new UMImage(getActivity(), "http://image.uuu9.com/pcgame/dota2/UploadFiles/201504/201504181115246071.jpg"));
//设置点击分享内容的跳转链接
        qqShareContent.setTargetUrl("http://www.163.com");
...
//设置点击消息的跳转URL
        qzone.setTargetUrl("http://www.163.com");
//设置分享内容的标题
        qzone.setTitle("QZone title");
//设置分享图片
        qzone.setShareImage(new UMImage(getActivity(), "http://image.uuu9.com/pcgame/dota2/UploadFiles/201504/201504181115246071.jpg"));
...
//        qqShareContent.setShareMedia(uMusic);
        qqShareContent.setTargetUrl("http://www.163.com");
        qqShareContent.setShareContent("我是内容");
        qqShareContent.setAppWebSite("我是site");
        UMImage umImage = new UMImage(getActivity(), "http://img0.bdstatic.com/img/image/shouye/sheying0420.jpg");
        umImage.setTargetUrl("http://www.mi.com");
    ...
    private void addQQQZonePlatform() {
        String appId = "1103881747";
        String appKey = "gCZ4dZXtG5JMtBOe";
        // 添加QQ支持, 并且设置QQ分享内容的target url
        UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler(getActivity(),
                appId, appKey);
        qqSsoHandler.setTargetUrl("http://www.163.com");
        qqSsoHandler.addToSocialSDK();
